node {
    stage ('Provisioning') {
        git 'https://github.com/RunOpenCode/query-resources-loader-bundle'
    }
    ...
    stage('Reporting') {
        ...
        step([$class: 'CloverPublisher', cloverReportDir: 'build/coverage/xml', cloverReportFileName: 'index.xml'])
    }
}